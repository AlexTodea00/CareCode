  ...
  return (
    <section ref={ref} className={`${styles.container} bg-[#f9fafb] `}>
      ...
      >
        <AccordionItem value="item-1">
          ...
          <AccordionContent>
            ...
            control exactly what information is accessible when your QR code is
            scanned.
          </AccordionContent>
        </AccordionItem>
      </Accordion>
      <Accordion className={`${styles.accordion}`} type="single" collapsible>
        <AccordionItem value="item-1">
          ...
          <AccordionContent>
            ...
            logging into your account. Changes are instantly reflected when your
            QR code is scanned, without needing to replace your stickers or
            products.
          </AccordionContent>
        </AccordionItem>
      </Accordion>
      ...
      <Accordion className={`${styles.accordion}`} type="single" collapsible>
        <AccordionItem value="item-1">
          <AccordionTrigger>
            What happens if my QR code is scanned by someone other than medical
            personnel?
          </AccordionTrigger>
          <AccordionContent>
